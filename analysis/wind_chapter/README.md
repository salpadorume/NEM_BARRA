...
This chapter should be run before the notebooks in analysis/alpine_wind.
The main workflow builds wind-profile difference curves, clusters the wind units, and then uses those cluster maps in the bootstrap and summary notebooks.
...
- Produces regional summary curves and chapter-ready plots.
...
- Uses the wind spatial cluster map to compare heatwave-day regimes.
Reads: "ID_HW_BARRA/data/preprocess/wind_spatial_clusters.csv"
Writes: derived tables and figures in data/output/wind_chapter
Environment: analysis3
Compute: xxlarge
